...
namespace IO.Swagger.Model
{
        ...
        public partial class UpdatableActivity :  IEquatable<UpdatableActivity>, IValidatableObject
    {
        ...
        public UpdatableActivity(bool? commute = default(bool?), bool? trainer = default(bool?), bool? hideFromHome = default(bool?), string description = default(string), string name = default(string), ActivityType type = default(ActivityType), string gearId = default(string))
        {
