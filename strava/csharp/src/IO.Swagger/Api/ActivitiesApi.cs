...
namespace IO.Swagger.Api
{
        ...
        public interface IActivitiesApi : IApiAccessor
    {
        ...
        ApiResponse<DetailedActivity> CreateActivityWithHttpInfo (string name, string type, DateTime? startDateLocal, int? elapsedTime, string description, float? distance, int? trainer, int? commute, bool? hideFromHome);
        /// <summary>
        /// Get Activity
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<DetailedActivity> CreateActivityAsync (string name, string type, DateTime? startDateLocal, int? elapsedTime, string description, float? distance, int? trainer, int? commute, bool? hideFromHome);
        ...
        System.Threading.Tasks.Task<ApiResponse<DetailedActivity>> CreateActivityAsyncWithHttpInfo (string name, string type, DateTime? startDateLocal, int? elapsedTime, string description, float? distance, int? trainer, int? commute, bool? hideFromHome);
        /// <summary>
        /// Get Activity
        /// </summary>
        /// <remarks>
        ...
        public partial class ActivitiesApi : IActivitiesApi
    {
        ...
        /// <param name="hideFromHome"></param>
        /// <returns>DetailedActivity</returns>
        public DetailedActivity CreateActivity (string name, string type, DateTime? startDateLocal, int? elapsedTime, string description, float? distance, int? trainer, int? commute, bool? hideFromHome)
        {
             ApiResponse<DetailedActivity> localVarResponse = CreateActivityWithHttpInfo(name, type, startDateLocal, elapsedTime, description, distance, trainer, commute, hideFromHome);
        ...
        /// <param name="hideFromHome"></param>
        /// <returns>ApiResponse of DetailedActivity</returns>
        public ApiResponse< DetailedActivity > CreateActivityWithHttpInfo (string name, string type, DateTime? startDateLocal, int? elapsedTime, string description, float? distance, int? trainer, int? commute, bool? hideFromHome)
        {
            ...
            // verify the required parameter 'hideFromHome' is set
            if (hideFromHome == null)
                throw new ApiException(400, "Missing required parameter 'hideFromHome' when calling ActivitiesApi->CreateActivity");
            ...
            if (hideFromHome != null) localVarFormParams.Add("hide_from_home", this.Configuration.ApiClient.ParameterToString(hideFromHome)); // form parameter
        ...
        /// <param name="hideFromHome"></param>
        /// <returns>Task of DetailedActivity</returns>
        public async System.Threading.Tasks.Task<DetailedActivity> CreateActivityAsync (string name, string type, DateTime? startDateLocal, int? elapsedTime, string description, float? distance, int? trainer, int? commute, bool? hideFromHome)
        {
             ApiResponse<DetailedActivity> localVarResponse = await CreateActivityAsyncWithHttpInfo(name, type, startDateLocal, elapsedTime, description, distance, trainer, commute, hideFromHome);
             return localVarResponse.Data;
        ...
        /// <param name="hideFromHome"></param>
        /// <returns>Task of ApiResponse (DetailedActivity)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DetailedActivity>> CreateActivityAsyncWithHttpInfo (string name, string type, DateTime? startDateLocal, int? elapsedTime, string description, float? distance, int? trainer, int? commute, bool? hideFromHome)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling ActivitiesApi->CreateActivity");
