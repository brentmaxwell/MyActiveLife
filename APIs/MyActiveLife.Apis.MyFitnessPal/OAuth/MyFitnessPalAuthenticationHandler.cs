...
{
    public partial class MyFitnessPalAuthenticationHandler : OAuthHandler<MyFitnessPalAuthenticationOptions>
    {
        /// <summary>
        /// Authentication handler for Strava authentication
        /// </summary>
        public MyFitnessPalAuthenticationHandler(
            [NotNull] IOptionsMonitor<MyFitnessPalAuthenticationOptions> options,
